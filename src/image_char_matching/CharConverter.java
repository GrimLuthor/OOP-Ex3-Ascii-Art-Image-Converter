 ...
 * The class converts characters to a binary "ascii_art_converter.image" (2D array of booleans).
 */
public class CharConverter {
     ...
     * constructor, to a square black&white ascii_art_converter.image (2D array of booleans),
